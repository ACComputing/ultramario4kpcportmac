...
def draw_mario(surf, x, y, state, frame, facing, big=False, fire=False):
	...
	if big:
		pygame.draw.rect(surf, hat, (rx, ry, width, 8))
		pygame.draw.rect(surf, hat, (rx + 4 if not flip else rx, ry, width - 4, 8))
		pygame.draw.rect(surf, C_MARIO_SKIN, (rx + 2, ry + 8, width - 4, 12))
		eye_x = rx + 14 if not flip else rx + 6
		pygame.draw.rect(surf, C_BLACK, (eye_x, ry + 10, 4, 3))
		pygame.draw.rect(surf, shirt, (rx + 4, ry + 20, width - 8, 16))
		pygame.draw.rect(surf, overall, (rx + 4, ry + 36, width - 8, 14))
		pygame.draw.rect(surf, C_COIN_GOLD, (rx + 8, ry + 38, 4, 4))
		pygame.draw.rect(surf, C_COIN_GOLD, (rx + width - 12, ry + 38, 4, 4))
		if state == 'walk' and int(frame) % 2 == 0:
			pygame.draw.rect(surf, overall, (rx, ry + 50, 12, 14))
			pygame.draw.rect(surf, overall, (rx + width - 12, ry + 50, 12, 14))
		elif state == 'jump':
			pygame.draw.rect(surf, overall, (rx, ry + 50, 12, 14))
			pygame.draw.rect(surf, overall, (rx + width - 12, ry + 46, 12, 18))
		else:
			pygame.draw.rect(surf, overall, (rx + 4, ry + 50, 10, 14))
			pygame.draw.rect(surf, overall, (rx + width - 14, ry + 50, 10, 14))
		pygame.draw.rect(surf, C_MARIO_BROWN, (rx, ry + 60, 14, 4))
		pygame.draw.rect(surf, C_MARIO_BROWN, (rx + width - 14, ry + 60, 14, 4))
	else:
		pygame.draw.rect(surf, hat, (rx + 2, ry, width - 4, 6))
		pygame.draw.rect(surf, C_MARIO_SKIN, (rx + 2, ry + 6, width - 4, 8))
		eye_x = rx + 10 if not flip else rx + 4
		pygame.draw.rect(surf, C_BLACK, (eye_x, ry + 8, 4, 2))
		pygame.draw.rect(surf, shirt, (rx + 4, ry + 14, width - 8, 8))
		pygame.draw.rect(surf, overall, (rx + 6, ry + 20, width - 12, 8))
		if state == 'walk' and int(frame) % 2 == 0:
			pygame.draw.rect(surf, overall, (rx, ry + 28, 8, 8))
			pygame.draw.rect(surf, overall, (rx + width - 8, ry + 28, 8, 8))
		elif state == 'jump':
			pygame.draw.rect(surf, overall, (rx + 2, ry + 28, 8, 10))
			pygame.draw.rect(surf, overall, (rx + width - 10, ry + 26, 8, 12))
		else:
			pygame.draw.rect(surf, overall, (rx + 4, ry + 28, 8, 8))
			pygame.draw.rect(surf, overall, (rx + width - 12, ry + 28, 8, 8))
		pygame.draw.rect(surf, C_MARIO_BROWN, (rx + 2, ry + 36, 10, 4))
		pygame.draw.rect(surf, C_MARIO_BROWN, (rx + width - 12, ry + 36, 10, 4))
